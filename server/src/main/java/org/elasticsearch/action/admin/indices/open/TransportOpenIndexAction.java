...
public class TransportOpenIndexAction extends TransportMasterNodeAction<OpenIndexRequest, OpenIndexResponse> {
    ...
    @Override
    public ClusterBlockException checkBlock(OpenIndexRequest request, ClusterState state) {
    ...
    @Override
    public void masterOperation(final OpenIndexRequest request, final ClusterState state, final ActionListener<OpenIndexResponse> listener) {
