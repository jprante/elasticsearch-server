...
public class ElasticsearchUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {

    private final Supplier<String> loggingPrefixSupplier;

    public ElasticsearchUncaughtExceptionHandler(final Supplier<String> loggingPrefixSupplier) {
    ...
    public static boolean isFatalUncaught(Throwable e) {
        return e instanceof Error;
    }

    public void onFatalUncaught(final String threadName, final Throwable t) {
    ...
    public void onNonFatalUncaught(final String threadName, final Throwable t) {
        final Logger logger = Loggers.getLogger(ElasticsearchUncaughtExceptionHandler.class, loggingPrefixSupplier.get());
