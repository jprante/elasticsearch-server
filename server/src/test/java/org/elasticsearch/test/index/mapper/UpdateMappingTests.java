...
public class UpdateMappingTests extends ESSingleNodeTestCase {
    ...
    public void testConflictSameType() throws Exception {
        ...
        try {
            mapperService.merge("type", new CompressedXContent(Strings.toString(update)), MapperService.MergeReason.MAPPING_UPDATE, false);
            fail();
        } catch (IllegalArgumentException e) {
    ...
    public void testReuseMetaField() throws IOException {
        ...
        try {
            mapperService.merge("type", new CompressedXContent(Strings.toString(mapping)), MapperService.MergeReason.MAPPING_UPDATE, false);
            fail();
        } catch (IllegalArgumentException e) {
