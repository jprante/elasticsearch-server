...
public class PathMatchDynamicTemplateTests extends ESSingleNodeTestCase {
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath(PathMatchDynamicTemplateTests.class,
                "/org/elasticsearch/test/index/mapper/dynamictemplate/pathmatch/test-mapping.json");
        ...
        byte[] json = copyToBytesFromClasspath(PathMatchDynamicTemplateTests.class,
                "/org/elasticsearch/test/index/mapper/dynamictemplate/pathmatch/test-data.json");
